...
//     console.log('==========');
//     console.log('Deployed LibAddressSet', addressSetLib.address);
//     console.log('Deployed LibPaginate', paginationLib.address);
//     console.log('Deployed LibHelpers', helpersLib.address);
//     console.log('==========');
...
//     stateManager.state = {
//       LibAddressSet: addressSetLib.address,
//       LibPaginate: paginationLib.address,
//       LibHelpers: helpersLib.address
//     };
//   });

// async function bootstrap(hre: HardhatRuntimeEnvironment, params: BootstrapTaskParams) {
//   // Deploy all needed libraries.
//   const addressSetLib = await deployLibrary(hre, 'LibAddressSet');
//   const paginationLib = await deployLibrary(hre, 'LibPaginate');
//   const helpersLib = await deployLibrary(hre, 'LibHelpers');
